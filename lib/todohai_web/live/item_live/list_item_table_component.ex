        ...
        <li class="list-group-item " style="border-radius: 0px;" id={"item-#{item.id}"}>
          <div class="form-check content d-flex flex-row justify-content-between" >
            ...
            <div>
              ...
              <svg phx-click="delete" data-confirm="Are you sure?" phx-value-id={item.id} id={"delete-item-#{item.id}"} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" phx-click="">
